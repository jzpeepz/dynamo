...
This section isn't necessary to know in order to use Dynamo. It is explaining encapsulated code within the package that you don't actually need to see,
...
.. image:: images/routesGenerated.png
   :align: center


The index function returns an index view or table of all the resources for that module. So in the Faq Category
...
.. image:: images/indexDynamoView.png
   :align: center
...
.. image:: images/createDynamoView.png
   :align: center
...
.. image:: images/storeDynamoView.png
   :align: center
...
.. image:: images/deleteFailDynamoView.png
   :align: center

Resulting DynamoView if object was successfully deleted:

.. image:: images/deleteDynamoView.png
  :align: center
