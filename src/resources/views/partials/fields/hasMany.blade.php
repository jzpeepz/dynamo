<div style="{{ $display ? 'display: block;' : 'display: none;' }}">
    ...
    <div class="form-group">
        ...
        @endif
        {!! Form::select($field->key.'[]', $field->options['options'], $item->{$field->key}->pluck('id')->toArray(), $field->getHtmlAttributes(['multiple' => true, 'class' => 'form-control '.$field->getOption('class')]) ) !!}
